...
| | |
|---|---|
| Versión del esquema | `1.0.0` (centinela `#FER1#`) |
| Claves normativas | `oc`, `ref`, `cbar` |
| Compatibilidad | Perfil heredado soportado, ver [§7](spec/v1.0.0.md#7-perfil-heredado) |
| Cambios | [CHANGELOG.md](CHANGELOG.md) |

## Cómo implementar

**Emisores.** Envolver los datos actuales en el bloque, separando el número de
pedido de su referencia. Ver [§4](spec/v1.0.0.md#4-emisión).

**Receptores.** Implementar la extracción según [§5](spec/v1.0.0.md#5-recepción) y
validar contra [`conformidad/casos.json`](conformidad/casos.json). Hay
implementaciones de referencia en Python y JavaScript en
[`referencia/`](referencia/README.md), sin dependencias, que pasan los 17 casos
normativos. Los otros 7 casos del archivo, marcados `"normativo": false`, ejercitan
las notas de implementación de [§5.3](spec/v1.0.0.md#53-notas-de-implementación--no-normativo)
